<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    $sql = "DELETE FROM outdoorstock WHERE outStId = '$id'";
...
<html lang="en">
<head>
  <title>Delete Outdoor Items</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container">
    <h1>Delete Outdoor Items</h1>
    <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10" id="cover">
      <form action="" method="post">
        <div class="form-group">
          <label for="id">Item Id:</label>
          <input type="text" class="form-control" placeholder="Delete Item Id" name="outStId" value="<?=$row["outStId"]?>">
        </div>
        <div class="form-group">
