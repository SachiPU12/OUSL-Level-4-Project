<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO outdoorstock (outStId, name, itemType, capacity) VALUES ('".$_POST["outStId"]."','".$_POST["name"]."','".$_POST["itemType"]."','".$_POST["capacity"]."')";
...
<html lang="en">
<head>
  <title>Insert Outdoor Items</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container">
    <h1>Insert Outdoor Items</h1><br>
    <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10" id="cover">
      <form action="" method="post">
        <div class="form-group">
          <label for="id">Item Id:</label>
          <input type="id" class="form-control" placeholder="Enter Item Id" name="outStId" required>
        </div>
        <div class="form-group">
