...
session_start();
  ...
  if (isset($_POST["submit"])) {
    ...
    $sql = "DELETE FROM storekeepers WHERE skId = '$id'";
...
<html lang="en">
<head>
  <title>Delete StoreKeepers</title>
  <meta charset="utf-8">
...
<body>
  <div class="container">
    ...
    <h1>Delete StoreKeepers</h1>
    <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10" id="cover">
      <form action="" method="post">
        <div class="form-group">
          <label for="cusId">StoreKeeper Id:</label>
          <input type="text" class="form-control" placeholder="Delete StoreKeeper Id" name="skId" value="<?=$row["skId"]?>">
        </div>
        <div class="form-group">
