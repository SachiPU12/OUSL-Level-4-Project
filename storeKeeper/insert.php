<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO storekeepers (skId, firstname, lastname, email, address) VALUES ('".$_POST["skId"]."','".$_POST["firstname"]."','".$_POST["lastname"]."','".$_POST["email"]."','".$_POST["address"]."')";
...
<html lang="en">
<head>
  <title>Insert StoreKeepers</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container">
    <h1>Insert StoreKeepers</h1><br>
    <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10" id="cover">
      <form action="" method="post">
        <div class="form-group">
          <label for="id">StoreKeeper Id:</label>
          <input type="id" class="form-control" placeholder="Enter Id" name="skId" required>
        </div>
        <div class="form-group">
