<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO suppliers (supId, firstname, lastname, email, address) VALUES ('".$_POST["supId"]."','".$_POST["firstname"]."','".$_POST["lastname"]."','".$_POST["email"]."','".$_POST["address"]."')";
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/suppliers.css"></script>
</head>

<body>
  <header><?php include '../login/nav.php'?></header>
  <div class="container">
    <h1>Insert Suppliers</h1><br>
    <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10" id="cover">
      <form action="" method="post">
        <div class="form-group">
          <label for="id">Supplier Id:</label>
          <input type="id" class="form-control" placeholder="Enter Id" name="supId" required>
        </div>
        <div class="form-group">
