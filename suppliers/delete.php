<?php
  ...
  if (isset($id)) {
    $sqlQuery = "SELECT * FROM suppliers WHERE supId = $id";
  ...
  if (isset($_POST["submit"])) {
    ...
    $sql = "DELETE FROM suppliers WHERE supId = '$id'";
    ...
    <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10" id="cover">
      <form action="" method="post">
        <div class="form-group">
          <label for="cusId">Suppler Id:</label>
          <input type="text" class="form-control" placeholder="Delete Suppler Id" name="supId" value="<?=$row["supId"]?>">
        </div>
        <div class="form-group">
